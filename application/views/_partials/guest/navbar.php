<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- <li class="nav-item">
                <a class="nav-link" data-toggle="modal" data-target="#exampleModal" href="<?= base_url('tulis_laporan') ?>">
            ...
            <!-- <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="aassets/img/undraw_rocket.svg" alt="...">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <a class="pt-4" href="<?= base_url('masyarakat/register') ?>"><span class="btn btn-outline-primary ml-2 mr-2 d-none d-lg-inline text-gray-600 small">Sign Up</span></a>
                        <a class="pt-4" href="<?= base_url('masyarakat') ?>"><span class="btn btn-outline-primary ml-2 mr-2 d-none d-lg-inline text-gray-600 small">Sign In</span></a>

                        <!-- Nav Item - User Information -->
                        <li class="nav-item dropdown no-arrow">
                            <!-- <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $username['username']; ?></span>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" class="form-control" id="inputCity" value="<?= $username['nik']; ?>" name="nik" readonly>
